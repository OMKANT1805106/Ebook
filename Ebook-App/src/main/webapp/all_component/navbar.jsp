...
<div class="container-fluid p-3 bg-light" >
	<div class="row">
		<div class="col-md-3 text-success">
			<h3>
				<i class="fa fa-bookmark" aria-hidden="true"></i> Ebook
			</h3>
		</div>
		<div class="col-md-6">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item active "><a class="nav-link" href="#"><i
					class="fa fa-book" aria-hidden="true"></i> Old Book</a></li>
		</ul>
		<form class="form-inline my-2 my-lg-0">
			...
			<button class="btn btn-outline-success my-2 my-sm-0 ml-1" type="submit">
				<i class="fa fa-compress" aria-hidden="true"></i> Contact Us
			</button>
		</form>
	</div>
</nav>
